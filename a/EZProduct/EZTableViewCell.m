...
+ (instancetype)cellWithTableView:(UITableView *)tableView {
    ...
    EZTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identify];
    if (cell == nil) {
        cell = [[EZTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identify];
...
- (void)setModel:(EZCellModel *)model {
    _model = model;
    [self setupData];
}
